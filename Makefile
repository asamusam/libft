...
CFILES := src/ft_atoi.c src/ft_bzero.c src/ft_calloc.c src/ft_isalnum.c src/ft_isalpha.c src/ft_isascii.c \
          src/ft_isdigit.c src/ft_isprint.c src/ft_isspace.c src/ft_itoa.c src/ft_memchr.c src/ft_memcmp.c src/ft_memcpy.c \
          ...
          src/ft_strlcat.c src/ft_strlcpy.c src/ft_strlen.c src/ft_strmapi.c src/ft_strncmp.c src/ft_strcmp.c src/ft_strnstr.c \
          ...
          src/ft_printf.c src/ft_printf_utils.c src/ft_getline.c src/ft_getline_utils.c
OFILES := $(CFILES:.c=.o)
INCLUDE := include
NAME := libft.a
